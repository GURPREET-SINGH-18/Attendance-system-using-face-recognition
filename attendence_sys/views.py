...
def home_main(request):
    return render(request, 'attendence_sys/mainHome.html')
...
def updateStudentRedirect(request):
    ...
    return render(request, 'attendence_sys/updatestudent.html', context)
...
def takeAttendence(request):
    ...
    context = {}
    return render(request, 'attendence_sys/takeattendace.html', context)
